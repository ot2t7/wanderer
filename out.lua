...
function lua_wrap_state(proto, env, upval)
	local function wrapped(...)
		...
		if result[1] then
			...
			print(failed.pc, failed.source, failed.lines)
...
return lua_wrap_state(lua_bc_to_state(base64Decode("")), getfenv())()
